 ...
 * \param *obj: ponteiro para a string correspondente ao nome do objeto que foi pedido
 * \param fd: inteiro correspondente ao file descriptor que está associado à sessão TCP donde veio a mensagem de interesse
 * \return 1 caso o mesmo pedido tenha vindo do mesmo vizinho, 0 caso contrário
 */
 ...
 * \param *id: ponteiro para a string correspondente ao identificador do nó que será returndo no final desta função
 * \return um ponteiro para a string correspondente ao identificador do nó 
 */
 ...
 * \return um ponteiro para a string resultante
 */
 ...
 * \return 1 se existir o objeto na lista e return 0 caso não exista
 */
int checkObjectList(list_objects *head_obj, char *name);

/**
 * createinsertObject: função que cria um objeto e adiciona a lista de objetos nomeados do nó (basicamente cria e adiciona um nó a lista simplesmente ligada) e return o topo da lista atualizado no final
 ...
 * \return 1 se existir o objeto na cache e return 0 caso não exista
 */
